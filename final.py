...
def searchstudent():
    ...
    searchroot.iconbitmap('mana1.ico')
...
def updatestudent():
    ...
    updateroot.iconbitmap('mana1.ico')
    ...
    emailentry = Entry(updateroot,font=('times',15,'bold'),bd=5,textvariable=idval)
    emailentry.place(x=250,y=190)
...
def Connectdb():
    ...
    #-------------------------------- Connectdb button
    submitbutton = Button(dbroot,text='Submit',font=('times',15,'bold'),bg='red',bd=5,width=20,activebackground='blue',
...
root.iconbitmap('mana1.ico')
root.resizable(True,True)
############################################################################################################  Frames
##---------------------------------------------------------------------------- dataentry frame

DataEntryFrame = Frame(root,bg='pink2',relief=GROOVE,borderwidth=5)
DataEntryFrame.place(x=10,y=80,width=500,height=600)
frontlabel = Label(DataEntryFrame,text='--------------Welcome--------------',width=30,font=('times',22,' bold'),bg='')
...
text = ''
##################################
SliderLabel = Label(root,text=ss,font=('times',29,' bold'),relief=RIDGE,borderwidth=4,width=35,bg='cyan')
...
connectbutton = Button(root,text='Connect To Database',width=16,font=('times',18,' bold'),relief=RIDGE,borderwidth=4,bg='green2',
